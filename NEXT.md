...
**Status re-checked 2026-09-01:** `/etc/clustly-agent.env` is absent and the
...
ledger, seven real third-party registrations, 20 checks and 293 tests. The same
...
tree hash and all 293 tests pass under local Node 18 with
